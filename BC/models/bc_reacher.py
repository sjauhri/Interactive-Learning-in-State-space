...
class BC_reacher(BC):
  def __init__(self, state_shape, action_shape, lr=0.0005, maxEpochs=100, epochTrainIts=6000, batch_size=32):
...
if __name__ == "__main__":
  bclone = BC_reacher(11, 2, lr=args.lr, maxEpochs=args.maxEpochs)
  bclone.run()
