...
class DCOACH_cartpole(DCOACH):
  def __init__(self, state_shape, action_shape, lr=0.001, maxEpisodes=30, batch_size=8):
...
if __name__ == "__main__":
  d_coach = DCOACH_cartpole(4, 2, lr=args.lr, maxEpisodes=args.maxEpisodes)
  d_coach.run()
