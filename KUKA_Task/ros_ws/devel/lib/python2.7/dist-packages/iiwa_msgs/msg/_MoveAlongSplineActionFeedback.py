...
"""autogenerated by genpy from iiwa_msgs/MoveAlongSplineActionFeedback.msg. Do not edit."""
import sys
...
class MoveAlongSplineActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "iiwa_msgs/MoveAlongSplineActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iiwa_msgs/MoveAlongSplineFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveAlongSplineActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = iiwa_msgs.msg.MoveAlongSplineFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = iiwa_msgs.msg.MoveAlongSplineFeedback()
