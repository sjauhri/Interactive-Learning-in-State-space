...
"""autogenerated by genpy from iiwa_msgs/MoveAlongSplineActionGoal.msg. Do not edit."""
import sys
...
class MoveAlongSplineActionGoal(genpy.Message):
  _md5sum = "e19048c94c23ce6966706e9d7d9a19d5"
  _type = "iiwa_msgs/MoveAlongSplineActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','iiwa_msgs/MoveAlongSplineGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveAlongSplineActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = iiwa_msgs.msg.MoveAlongSplineGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = iiwa_msgs.msg.MoveAlongSplineGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.goal.spline.segments)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.spline.segments:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.e1, _x.status, _x.turn,) = _get_struct_d2i().unpack(str[start:end])
        self.goal.spline.segments.append(val1)
      return self
