...
"""autogenerated by genpy from iiwa_msgs/MoveToCartesianPoseActionResult.msg. Do not edit."""
import sys
...
class MoveToCartesianPoseActionResult(genpy.Message):
  _md5sum = "89dbc4e75593b525bbbea3a150532ed6"
  _type = "iiwa_msgs/MoveToCartesianPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iiwa_msgs/MoveToCartesianPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveToCartesianPoseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = iiwa_msgs.msg.MoveToCartesianPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = iiwa_msgs.msg.MoveToCartesianPoseResult()
