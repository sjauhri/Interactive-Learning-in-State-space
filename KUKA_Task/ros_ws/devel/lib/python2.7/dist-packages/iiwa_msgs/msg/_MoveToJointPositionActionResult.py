...
"""autogenerated by genpy from iiwa_msgs/MoveToJointPositionActionResult.msg. Do not edit."""
import sys
...
class MoveToJointPositionActionResult(genpy.Message):
  _md5sum = "89dbc4e75593b525bbbea3a150532ed6"
  _type = "iiwa_msgs/MoveToJointPositionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iiwa_msgs/MoveToJointPositionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveToJointPositionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = iiwa_msgs.msg.MoveToJointPositionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = iiwa_msgs.msg.MoveToJointPositionResult()
