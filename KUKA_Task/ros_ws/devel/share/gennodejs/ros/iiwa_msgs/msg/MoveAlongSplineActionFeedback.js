...
class MoveAlongSplineActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveAlongSplineFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveAlongSplineActionFeedback(null);
    ...
    data.feedback = MoveAlongSplineFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveAlongSplineActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveAlongSplineFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveAlongSplineFeedback()
    }
...
module.exports = MoveAlongSplineActionFeedback;
