...
class MoveToCartesianPoseActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveToCartesianPoseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveToCartesianPoseActionFeedback(null);
    ...
    data.feedback = MoveToCartesianPoseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToCartesianPoseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveToCartesianPoseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveToCartesianPoseFeedback()
    }
...
module.exports = MoveToCartesianPoseActionFeedback;
