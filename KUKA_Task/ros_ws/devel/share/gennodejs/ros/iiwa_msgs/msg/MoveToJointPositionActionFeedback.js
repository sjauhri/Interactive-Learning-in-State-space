...
class MoveToJointPositionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveToJointPositionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveToJointPositionActionFeedback(null);
    ...
    data.feedback = MoveToJointPositionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToJointPositionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveToJointPositionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveToJointPositionFeedback()
    }
...
module.exports = MoveToJointPositionActionFeedback;
