...
parser.add_argument("--session_dir", help="where to save the session", required=True)
...
parser.add_argument("--dynamicsSamples", type=int, default=5000, help="the number of samples to initially learn the dynamics")
