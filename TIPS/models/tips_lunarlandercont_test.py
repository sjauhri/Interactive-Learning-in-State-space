...
class TIPS_lunarlandercont(TIPS):
  def __init__(self, state_shape, action_shape, lr=0.0005, maxEpisodes=50, epochTrainIts=5000,  dynamicsSamples=50000, batch_size=32):
